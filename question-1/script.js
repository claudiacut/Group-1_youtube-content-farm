...
container.appendChild(svgNode);
  ...
  white.on("mouseover", function(){
    ...
    compilation.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    rain.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    ...
    monsters.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    neww.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    good.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    bus.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    go.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    colors.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    yes.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    cars.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    shark.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    cartoon.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    toys.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
    stories.transition().duration(0).ease(d3.easeLinear).style("opacity","1");
