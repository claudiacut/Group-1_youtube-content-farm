...
container.appendChild(svgNode);
  ...
  white.on("mouseover", function(){
    ...
    compilation.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    rain.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    dad.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    mysterious.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    adventures.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    ...
    animals.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    police.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    little.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    monsters.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    neww.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    good.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    bus.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    go.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    colors.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    yes.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    cars.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    shark.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    cartoon.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    toys.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
    stories.transition().duration(1).ease(d3.easeLinear).style("opacity","1");
